...
1. Explain the difference between `Relational Databases` and `SQL`.
    - Relational Database are a way to store many types of data that all relate to each other. 
      SQL is a programming language that helps developers to manage databases.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    - We need a third table, which uses 'Foreign Key' to reference the 'Primary Keys' of those two tables. 
